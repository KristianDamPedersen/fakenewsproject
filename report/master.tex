...
convert the large CSV file into the more managable \textit{parquet} format. The advantage of parquet files, is that they
...
enable chunk-based operations, lazy calculations and even multithreading and distributing work across computers.
