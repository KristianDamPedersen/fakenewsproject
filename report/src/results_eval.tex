...
These different metrics can be difficult to parse when evaluating on unbalanced datasets. This is where visual aids can come in handy. Confusion matrixes and ROC curves effectively show how horribly bad our models were, at predicting out of domain. We decided to visualize the performance using ROC comparison, and as we see from figure \ref{fig:roc}, all of the models lose.........
