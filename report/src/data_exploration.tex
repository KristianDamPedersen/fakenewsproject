...
After getting the data into a managable format, we were then able to start properly exploring it. We started by
...
to separate from everything else, other clusters far apart include unreliable and rumors. This serves as our justification for our binary grouping of the dataset since realiable articles are clearly delineated from the rest of the dataset. 
