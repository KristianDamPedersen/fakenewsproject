...
We decided to split our data into into a training, validation and testing set, with a 80-10-10 split. And then balanced
the training data.
...
be useful for us to reduce the dimensionality of our input tensor. In other words, we wanted to group similar elements
(or flags) together, such that the models we build have a more clear delineation between inputs. To do this we used
